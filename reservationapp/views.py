    ...
    if request.method == 'POST':
        ...
        if place == '':
            ...
            if b.count() == 0:
                ...
                error_msg = '预约失败，该仪器在此时段已经被预约'
        return render(request, 'reservationapp/index2_wx.html', {'error_msg': error_msg, 'instrument': instrument_name})
    return render(request, 'reservationapp/index2_wx.html', {'instrument': instrument_name})
